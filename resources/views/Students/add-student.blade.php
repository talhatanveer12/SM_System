    ...
    <div class="col-span-12 flex-col ">
        ...
        <div class="flex p-2 bg-blue-100 justify-center flex-wrap">
            ...
            <div class="mb-6 mr-2">
                ...
                <input class="border border-gray-400 p-2 w-64" type="date" name="Date of Birth" id="Date of Birth" />
            </div>
            ...
            <div class="mb-6 mr-2">
                <x-form.label name="Student Photo" />
                <input class="border border-gray-400 p-2 w-64" type="file" name="Student Photo"
                    id="Student Photo" />
            </div>
            <div class="mb-6 mr-2">
                <x-form.label name="Admission date" />
                <input class="border border-gray-400 p-2 w-64" type="date" name="Admission date"
                    id="Admission date" />
            </div>
        </div>
    </div>
