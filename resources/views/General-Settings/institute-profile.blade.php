<x-layout.bootstrap-layout>
        ...
        <div class="col-span-12 lg:col-span-6 lg:col-start-2 md:col-span-9 md:col-start-2 sm:col-span-12 sm:col-span-3">
        ...
        <div class="col-span-12 lg:col-start-9 md:col-span-6 md:col-start-4 sm:col-span-8 sm:col-start-3">
            <section class="px-6 py-8">
                <div
