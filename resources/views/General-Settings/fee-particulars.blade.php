<x-layout.layout>
    <div class="bg-blue-200 border col-span-8 hover:shadow-2xl lg:col-start-4 md:col-start-3 rounded-2xl shadow-md sm:col-start-2">
        <section class="px-6 py-8">
            <h1>Change Fee Particular </h1>
            <div class="grid grid-cols-3 gap-2">
                <div class="col-span-2 mt-4">
                    <h2>Particular Name</h2>
                </div>
                <div class="mt-4">
                    <h2>Prefix Amount</h2>
                </div>
